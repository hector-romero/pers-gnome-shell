...
function init() {
    ...
    if (current_version.length > 4 || current_version[0] != 3) throw new Error("Strange version number (extension.js:35).")
    ...
    switch (current_version[1]) {
        ...
        case"8":
            break
        default: throw new Error("Strange version number (extension.js:46).")
    }
