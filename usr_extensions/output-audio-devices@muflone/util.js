...
const EXTENSION_NAME = 'output-audio-devices'
const SETTINGS_SCHEMA = 'org.gnome.shell.extensions.' + EXTENSION_NAME;
const GETTEXT_DOMAIN = 'gnome-shell-extensions-' + EXTENSION_NAME
...
function initTranslations(domain) {
    ...
    domain = domain || GETTEXT_DOMAIN || extension.metadata['gettext-domain'];
    global.log(domain);
